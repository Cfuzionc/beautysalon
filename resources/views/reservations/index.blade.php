                    ...
                    <div class="card my-4">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                <h6 class="text-white text-capitalize ps-3">Reservation Table</h6>
                            </div>
                        </div>
                                ...
                                <table class="table align-items-center mb-0">
                                    ...
                                    <tr>
                                        ...
                                        <th
                                            ...
                                            Preferred Employee</th>
                                        <th
                                            class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">
                                            Date Time</th>
                                        <th
                                            class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">
                                            Reservation Created</th>
                                            ...
                                            <td class="align-middle">
                                                <form class="nav-link" method="POST" action="{{ route('reservation.destroy', $reservation->uuid)}}">
                                                    ...
                                                    <button class="text-secondary font-weight-bold text-xs"
                                                        data-toggle="tooltip" data-original-title="Edit user" type="submit">
                                                            Delete
                                                    </button>
                                                </form>
                                            </td>
